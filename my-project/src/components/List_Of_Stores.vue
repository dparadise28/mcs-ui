...
<style>
  ...
  .pagination>li.active>a {
    box-shadow: rgba(0, 0, 0, 0.498039) 4px 11px 35px -14px;
    background: #1b9872 !important;
    color: rgb(255, 255, 255) !important;
  }

  .pagination>li.active>a:hover {
    cursor: pointer;
    background: rgb(65, 164, 243) !important;}
</style>
